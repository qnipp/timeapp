...
Router.route('/iamin', function() {
	...
	waitOn: function () {
		...
		// FIXME takes ages 
	//	return Meteor.subscribe('data.all');
	},
});
...
Router.route('/time/:_id', function() {
	...
	console.log("iron:router - route:" + Router.current().route._path + " [" + Router.current().route.getName() + "] "+ this.params._id);
	...
	if(this.params._id != '' && this.params._id != '0') {
		...
		Meteor.call("findTime", this.params._id,
...
Router.route('/attrib/:_id', function() {
	console.log("iron:router - route:" + Router.current().route._path + " [" + Router.current().route.getName() + "]");
...
Router.route('/attrib/:_id/create', function() {
	console.log("iron:router - route:" + Router.current().route._path + " [" + Router.current().route.getName() + "]");

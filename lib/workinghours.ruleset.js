...
CNF.workinghours.ruleset = [
  ...
  // days
  {
    ...
    fn() { return this.time.workingtime > 8 *this.hours; },
    'alert': 'warning',
  ...
  },
  {
    'context': 'days',
    'groupkey': 'workinghours',
    fn() { return this.time.workingtime > 10 *this.hours; },
    'alert': 'danger',
  ...
  },
  {
    'context': 'days',
    'groupkey': 'sparetime',
    fn() { return (this.time.start - this.previous.end) < 11 *this.hours; },
    'alert': 'warning',
  ...
  },
  {
    'context': 'days',
    'groupkey': 'sparetime',
    fn() { return (this.time.start - this.previous.end) < 10 *this.hours; },
    'alert': 'danger',
  ...
  },
  {
    'context': 'days',
    'groupkey': 'pauses',
    fn() { return this.time.workingtime > 6 *this.hours && Math.max(...this.time.pauses) < CNF.workinghours.pause_main_minimum *this.hours; },
    'alert': 'danger',
    'message': 'The pause is shorter than '+ CNF.workinghours.pause_main_minimum +' hours.',
  },
  ...
  // the continuous work parts will change.
  {
    'context': 'days',
    'groupkey': 'pausestart',
    fn() { return Math.max(...this.time.continuouswork) > 5.5 *this.hours; },
    'alert': 'warning',
  ...
  },
  {
    'context': 'days',
    'groupkey': 'pausestart',
    fn() { return Math.max(...this.time.continuouswork) > 6 *this.hours; },
    'alert': 'danger',
  ...
  // weeks
  {
    'context': 'weeks',
    'groupkey': 'workinghours',
    fn() { return this.time.workingtime > 38.5 *this.hours; },
    'alert': 'warning',
  ...
  },
  {
    'context': 'weeks',
    'groupkey': 'workinghours',
    fn() { return this.time.workingtime > 50 *this.hours; },
    'alert': 'danger',
